...
function createTeamDetails (team) {
  ...
  dataTable.appendChild(
    createTeamDetailsDataRow('F/M (Home)', team.goalsForHome / team.matchesPlayedHome)
  );
  dataTable.appendChild(
    createTeamDetailsDataRow('F/M (Away)', team.goalsForAway / team.matchesPlayedAway)
  );
  ...
  dataTable.appendChild(
    createTeamDetailsDataRow('A/M (Home)', team.goalsAgainstHome / team.matchesPlayedHome)
  );
  dataTable.appendChild(
    createTeamDetailsDataRow('A/M (Away)', team.goalsAgainstAway / team.matchesPlayedAway)
  );
